            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td style="color:#FFFFFF;font-size:20px;font-weight:700;
                  ...
                  {BRAND_NAME}
                  <span style="font-weight:400;color:#CBD5E1;font-size:13px;
                               margin-left:10px;letter-spacing:0.2px;">
                    {BRAND_TAGLINE}
                  </span>
                </td>
...
def to_plain_text(heading: str, body_text: str, cta_label: str | None = None,
