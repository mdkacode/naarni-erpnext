...
import { c as ue } from "./api-BQ4HYjks.js";
import { _ as pe } from "./Wizard-B-0QL5XK.js";
...
const P = "Good",
	...
	q = [
		...Y.map((l) => F(A({}, l), { id: l.id.replace("b_", "c_") })),
		{
	...
	_e = [
		...q.map((l) => F(A({}, l), { id: l.id.replace("c_", "d_") })),
		{
			id: "d_compression",
...
function he(l) {
	...
	return c > ye
		...
		: c > be
		? { sheetId: "C", sheetLabel: "Comprehensive Inspection (40,001–80,000 km)", items: q }
		: c > ge
		? { sheetId: "B", sheetLabel: "Standard Inspection (20,001–40,000 km)", items: Y }
...
const ve = { class: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8" },
	...
	Pe = { key: 2 },
	Je = ["value", "onInput"],
	Ye = { class: "mt-4 text-xs text-gray-400 text-center" },
	qe = { class: "space-y-5" },
...
//# sourceMappingURL=TechnicianInspection-CncbqsP_.js.map
