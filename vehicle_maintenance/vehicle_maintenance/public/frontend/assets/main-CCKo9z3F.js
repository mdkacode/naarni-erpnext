const __vite__mapDeps = (
	...
	d = m.f ||
		(m.f = [
			"assets/Dashboard-Y4T2R-pp.js",
			"assets/StatusBadge-NvleVmQJ.js",
			"assets/api-BQ4HYjks.js",
			"assets/DepotManagerDashboard-0K-8wo5u.js",
			"assets/CentralOpsDashboard-sdDGhZsz.js",
			"assets/CustomerDashboard-Kt0B4v1f.js",
			"assets/JobCardNew-CZI8oxaO.js",
			"assets/Wizard-B-0QL5XK.js",
			"assets/_plugin-vue_export-helper-DlAUqK2U.js",
			"assets/JobCardNew-Dn4p3nie.css",
			"assets/HealthCardView-Bj9BEJNp.js",
			"assets/HealthScoreCard-D66qSILr.js",
			"assets/CustomerJobCard-DlPTHSDa.js",
			"assets/CustomerJobCard-B_4xtlIM.css",
			"assets/TechnicianInspection-CncbqsP_.js",
			"assets/TechnicianInspection-BPJuQxSt.css",
			"assets/LeadsList-DuwekaiL.js",
			"assets/useCrmDropdowns-HGNnfTWS.js",
			"assets/LeadsList-DAOTEpJw.css",
			"assets/LeadNew-L7lQULxj.js",
			"assets/LeadNew-Cuk5GImZ.css",
			"assets/LeadDetail-BaEDrVGk.js",
...
const ne = {},
	...
	lo = (e) => (Q(e) || q(e)) && q(e.then) && q(e.catch),
	...
	Ql = /-\w/g,
	Ee = gr((e) => e.replace(Ql, (t) => t.slice(1).toUpperCase())),
	Zl = /\B([A-Z])/g,
	Mt = gr((e) => e.replace(Zl, "-$1").toLowerCase()),
...
const ho = (e) => !!(e && e.__v_isRef === !0),
	po = (e) =>
		ce(e)
			...
			: e == null
			? ""
			: U(e) || (Q(e) && (e.toString === co || !q(e.toString)))
			? ho(e)
				? po(e.value)
	...
	if ((Rs(), t === "clear")) l.forEach(c);
		...
		if (o && n === "length") {
			...
			switch (((n !== void 0 || l.has(void 0)) && c(l.get(n)), f && c(l.get(An)), t)) {
				case "add":
					o ? f && c(l.get("length")) : (c(l.get(Lt)), Gt(e) && c(l.get(Zr)));
					break;
				case "delete":
					o || (c(l.get(Lt)), Gt(e) && c(l.get(Zr)));
					break;
				case "set":
					Gt(e) && c(l.get(Lt));
					break;
...
function jt(e) {
	const t = Y(e);
	return t === e ? t : (ge(t, "iterate", An), Be(e) ? t : t.map(He));
}
function br(e) {
	return ge((e = Y(e)), "iterate", An), e;
}
function Xe(e, t) {
	return gt(e) ? en(Bt(e) ? He(t) : t) : He(t);
}
const hc = {
	__proto__: null,
	[Symbol.iterator]() {
	...
	concat(...e) {
		return jt(this).concat(...e.map((t) => (U(t) ? jt(t) : t)));
	},
	entries() {
...
function Mr(e, t, n) {
	...
	ge(r, "iterate", An);
	const s = r[t](...n);
	return (s === -1 || s === !1) && Ns(n[0]) ? ((n[0] = Y(n[0])), r[t](...n)) : s;
}
function un(e, t, n = []) {
	dt(), Rs();
...
class Ro {
	...
	get(t, n, r) {
		...
		const c = Reflect.get(t, n, ye(t) ? t : r);
		if ((Ue(n) ? xo.has(n) : pc(n)) || (s || ge(t, "get", n), i)) return c;
		if (ye(c)) {
			const o = l && ws(n) ? c : c.value;
			return s && Q(o) ? ts(o) : o;
		}
		return Q(c) ? (s ? ts(c) : it(c)) : c;
	}
}
class Ao extends Ro {
	constructor(t = !1) {
	...
	set(t, n, r, s) {
		...
		if (!this._isShallow) {
			const f = gt(i);
			if ((!Be(r) && !gt(r) && ((i = Y(i)), (r = Y(r))), !l && ye(i) && !ye(r)))
				return f || (i.value = r), !0;
		}
		const c = l ? Number(n) < t.length : X(t, n),
			o = Reflect.set(t, n, r, ye(t) ? t : s);
		return t === Y(s) && (c ? Ze(r, i) && ft(t, "set", n, r) : ft(t, "add", n, r)), o;
	}
	deleteProperty(t, n) {
		const r = X(t, n);
		t[n];
	...
	has(t, n) {
		...
		return (!Ue(n) || !xo.has(n)) && ge(t, "has", n), r;
	}
	ownKeys(t) {
		return ge(t, "iterate", U(t) ? "length" : Lt), Reflect.ownKeys(t);
	}
}
class mc extends Ro {
	constructor(t = !1) {
	...
	const n = {
		get(s) {
			const i = this.__v_raw,
				l = Y(i),
				c = Y(s);
			e || (Ze(s, c) && ge(l, "get", s), ge(l, "get", c));
			const { has: o } = Un(l),
				f = t ? es : e ? en : He;
		...
		get size() {
			const s = this.__v_raw;
			return !e && ge(Y(s), "iterate", Lt), s.size;
		},
		has(s) {
			const i = this.__v_raw,
				l = Y(i),
				c = Y(s);
			return (
				e || (Ze(s, c) && ge(l, "has", s), ge(l, "has", c)), s === c ? i.has(s) : i.has(s) || i.has(c)
			);
		},
		forEach(s, i) {
			const l = this,
				...
				o = Y(c),
				f = t ? es : e ? en : He;
			return !e && ge(o, "iterate", Lt), c.forEach((a, u) => s.call(i, f(a), f(u), l));
		},
	};
	return (
		pe(
				...
				: {
						...
						set(s, i) {
							...
							const l = Y(this),
								{ has: c, get: o } = Un(l);
							let f = c.call(l, s);
							f || ((s = Y(s)), (f = c.call(l, s)));
							const a = o.call(l, s);
							return l.set(s, i), f ? Ze(i, a) && ft(l, "set", s, i) : ft(l, "add", s, i), this;
						},
						delete(s) {
							const i = Y(this),
								{ has: l, get: c } = Un(i);
							let o = l.call(i, s);
							o || ((s = Y(s)), (o = l.call(i, s))), c && c.call(i, s);
							const f = i.delete(s);
							return o && ft(i, "delete", s, void 0), f;
						},
						clear() {
							const s = Y(this),
								i = s.size !== 0,
								l = s.clear();
							return i && ft(s, "clear", void 0, void 0), l;
						},
				  }
		),
...
function Ts(e, t) {
	...
	return (r, s, i) =>
		s === "__v_isReactive"
			...
			: s === "__v_raw"
			? r
			: Reflect.get(X(n, s) && s in r ? n : r, s, i);
}
const wc = { get: Ts(!1, !1) },
	Sc = { get: Ts(!1, !0) },
	xc = { get: Ts(!0, !1) };
...
function Bt(e) {
	return gt(e) ? Bt(e.__v_raw) : !!(e && e.__v_isReactive);
}
function gt(e) {
...
function Cc(e) {
	return !X(e, "__v_skip") && Object.isExtensible(e) && uo(e, "__v_skip", !0), e;
}
const He = (e) => (Q(e) ? it(e) : e),
	en = (e) => (Q(e) ? ts(e) : e);
function ye(e) {
...
class Pc {
	...
	set value(t) {
		const n = this._rawValue,
			r = this.__v_isShallow || Be(t) || gt(t);
		(t = r ? t : Y(t)),
...
function Lc(e, t, n = ne) {
	const { immediate: r, deep: s, once: i, scheduler: l, augmentJob: c, call: o } = n,
		f = (O) => (s ? O : Be(O) || s === !1 || s === 0 ? ht(O, 1) : ht(O));
	let a,
		u,
		p,
		m,
...
function ht(e, t = 1 / 0, n) {
	...
	if ((n.set(e, t), t--, ye(e))) ht(e.value, t, n);
	else if (U(e)) for (let r = 0; r < e.length; r++) ht(e[r], t, n);
	else if (pr(e) || Gt(e))
		e.forEach((r) => {
			ht(r, t, n);
		});
...
function Is(e) {
	if (!(e.flags & 1)) {
		const t = On(e),
			n = ve[ve.length - 1];
		!n || (!(e.flags & 2) && t >= On(n)) ? ve.push(e) : ve.splice(Mc(t), 0, e), (e.flags |= 1), ko();
	}
}
function ko() {
	nr || (nr = Io.then(Bo));
...
function Bo(e) {
	try {
		...
		(ze = -1), (ve.length = 0), Lo(), (nr = null), (ve.length || Jt.length) && Bo();
	}
}
let de = null,
	Mo = null;
...
function ia(e, t, n = !0, r = !1) {
	...
	if (s) {
		...
		{
			const c = $a(i, !1);
			if (c && (c === t || c === Ee(t) || c === mr(Ee(t)))) return i;
		}
...
function od(e, t, n, r) {
	...
	if (l || ce(e)) {
		...
		let o = !1,
			f = !1;
		c && ((o = !Be(e)), (f = gt(e)), (e = br(e))), (s = new Array(e.length));
...
function ci(e, t, n = {}, r, s) {
	if (de.ce || (de.parent && Yt(de.parent) && de.parent.ce)) {
		...
		return t !== "default" && (n.name = t), tn(), lr(Ie, null, [ee("slot", n, r)], f ? -2 : 64);
	}
	let i = e[t];
	i && i._c && (i._d = !1), tn();
	const l = i && Wo(i(n)),
...
function Wo(e) {
	return e.some((t) => (Tn(t) ? !(t.type === mt || (t.type === Ie && !Wo(t.children))) : !0)) ? e : null;
}
const ns = (e) => (e ? (dl(e) ? xr(e) : ns(e.parent)) : null),
	...
	Fr = (e, t) => e !== ne && !e.__isScriptSetup && X(e, t),
	oa = {
		get({ _: e }, t) {
			...
			if (t[0] !== "$") {
				...
				if (p !== void 0)
					...
					if (s !== ne && X(s, t)) return (l[t] = 2), s[t];
					if (X(i, t)) return (l[t] = 3), i[t];
					if (n !== ne && X(n, t)) return (l[t] = 4), n[t];
					rs && (l[t] = 0);
				}
			}
			const f = vn[t];
			...
			if (n !== ne && X(n, t)) return (l[t] = 4), n[t];
			if (((u = o.config.globalProperties), X(u, t))) return u[t];
		},
		set({ _: e }, t, n) {
...
function la(e) {
	...
	if (((rs = !0), i))
		for (const Z in i) {
			const J = i[Z],
				...
				bt = !q(J) && q(J.set) ? J.set.bind(n) : et,
				Ke = Ae({ get: ot, set: bt });
	...
	if (c) for (const Z in c) Go(c[Z], r, n, Z);
	if (o) {
		const Z = q(o) ? o.call(n) : o;
	...
	a && ui(a, e, "c");
	function ue(Z, J) {
		U(J) ? J.forEach((ot) => Z(ot.bind(n))) : J && Z(J.bind(n));
	}
	if (
		(ue(Jc, u),
		ue(zc, p),
		...
		if (Oe.length) {
			...
			Oe.forEach((J) => {
				Object.defineProperty(Z, J, { get: () => n[J], set: (ot) => (n[J] = ot), enumerable: !0 });
			});
		} else e.exposed || (e.exposed = {});
	K && e.render === et && (e.render = K),
		_t != null && (e.inheritAttrs = _t),
		Ot && (e.components = Ot),
		qe && (e.directives = qe),
		fe && Ho(e);
}
function ca(e, t, n = et) {
	...
	for (const r in e) {
		const s = e[r];
		let i;
		Q(s) ? ("default" in s ? (i = Ve(s.from || r, s.default, !0)) : (i = Ve(s.from || r))) : (i = Ve(s)),
			ye(i)
...
function ga(e, t, ...n) {
	...
	let c,
		o = r[(c = Ir(t))] || r[(c = Ir(Ee(t)))];
	!o && i && (o = r[(c = Ir(Mt(t)))]), o && rt(o, e, 6, s);
	const f = r[c + "Once"];
	if (f) {
...
function Yo(e, t, n = !1) {
	...
	return !i && !c
		...
		: (U(i) ? i.forEach((o) => (l[o] = null)) : pe(l, i), Q(e) && r.set(e, l), l);
}
function wr(e, t) {
	return !e || !hr(t)
		? !1
		: ((t = t.slice(2).replace(/Once$/, "")),
		  X(e, t[0].toLowerCase() + t.slice(1)) || X(e, Mt(t)) || X(e, t));
}
function di(e) {
	const {
			type: t,
...
function Xo(e, t, n) {
	const r = e[n],
		s = t[n];
	return n === "style" && Q(r) && Q(s) ? !kn(r, s) : r !== s;
}
...
function wa(e, t, n, r) {
	...
	if ((r || l > 0) && !(l & 16)) {
		...
		let a;
		for (const u in c)
			(!t || (!X(t, u) && ((a = Mt(u)) === u || !X(t, a)))) &&
				(o
					? n && (n[u] !== void 0 || n[a] !== void 0) && (s[u] = is(o, c, u, void 0, e, !0))
					: delete s[u]);
		if (i !== c) for (const u in i) (!t || !X(t, u)) && (delete i[u], (f = !0));
	}
	f && ft(e.attrs, "set", "");
}
function tl(e, t, n, r) {
...
function nl(e, t, n = !1) {
	...
	if (!i && !o) return Q(e) && r.set(e, Wt), Wt;
	if (U(i))
		for (let a = 0; a < i.length; a++) {
			const u = Ee(i[a]);
			gi(u) && (l[u] = ne);
		...
		for (const a in i) {
			...
			if (gi(u)) {
				...
				(m[0] = R), (m[1] = w), (R || X(m, "default")) && c.push(u);
			}
		}
	const f = [l, c];
...
function Ca(e, t) {
	...
	const {
		...
		R = (h, d, g, y = null, v = null, _ = null, D = void 0, C = null, x = !!d.dynamicChildren) => {
			if (h === d) return;
			h && !fn(h, d) && ((y = b(h)), we(h, v, _, !0), (h = null)),
		...
		Z = (h, d, g) => {
			...
			(h.vnode = d), (h.next = null), wa(h, d.props, y, g), Aa(h, d.children, g), dt(), si(h), pt();
		},
		...
		ot = (h, d, g, y, v, _, D, C, x) => {
			...
			let F;
			for (F = 0; F < k; F++) {
				const H = (d[F] = x ? ut(d[F]) : Qe(d[F]));
				R(h[F], H, g, null, v, _, D, C, x);
			}
			E > V ? Ne(h, v, _, !0, !1, k) : j(d, g, y, v, _, D, C, x, k);
		},
		bt = (h, d, g, y, v, _, D, C, x) => {
			let E = 0;
			const V = d.length;
			let k = h.length - 1,
				F = V - 1;
			...
			if (E > k) {
				if (E <= F) {
					const H = F + 1,
						G = H < V ? d[H].el : y;
					for (; E <= F; ) R(null, (d[E] = x ? ut(d[E]) : Qe(d[E])), g, G, v, _, D, C, x), E++;
				}
			} else if (E > F) for (; E <= k; ) we(h[E], v, _, !0), E++;
			else {
				const H = E,
					G = E,
					te = new Map();
				for (E = G; E <= F; E++) {
					const Ce = (d[E] = x ? ut(d[E]) : Qe(d[E]));
		...
		Ct = (h, d, g) => {
			...
			mi(x),
				...
				y && $n(y),
				v.stop(),
				_ && ((_.flags |= 8), we(D, h, d, g)),
				C && xe(C, d),
				xe(() => {
					h.isUnmounted = !0;
				}, d);
		},
		Ne = (h, d, g, y = !1, v = !1, _ = 0) => {
			for (let D = _; D < h.length; D++) we(h[D], d, g, y, v);
		},
		b = (h) => {
	...
	const I = (h, d, g) => {
			let y;
			h == null
				? d._vnode && (we(d._vnode, null, null, !0), (y = d._vnode.component))
				: R(d._vnode || null, h, d, null, null, null, g),
				(d._vnode = h),
				L || ((L = !0), si(y), Lo(), (L = !1));
		},
		M = { p: R, um: we, m: Ke, r: Vt, mt: cn, mc: j, pc: J, pbc: Oe, n: b, o: e };
...
function ol(e, t, n = !1) {
	...
	if (U(r) && U(s))
		for (let i = 0; i < r.length; i++) {
			...
			c.shapeFlag & 1 &&
				!c.dynamicChildren &&
				((c.patchFlag <= 0 || c.patchFlag === 32) && ((c = s[i] = ut(s[i])), (c.el = l.el)),
				!n && c.patchFlag !== -2 && ol(l, c)),
				c.type === Sr && (c.patchFlag === -1 && (c = s[i] = ut(c)), (c.el = l.el)),
				c.type === mt && !c.el && (c.el = l.el);
		}
}
function Pa(e) {
	const t = e.slice(),
...
function Da() {
	En.pop(), (Pe = En[En.length - 1] || null);
}
let Cn = 1;
function or(e, t = !1) {
	(Cn += e), e < 0 && Pe && t && (Pe.hasOnce = !0);
}
function ul(e) {
	return (e.dynamicChildren = Cn > 0 ? Pe || Wt : null), Da(), Cn > 0 && Pe && Pe.push(e), e;
}
...
const hl = ({ key: e }) => (e != null ? e : null),
	Gn = ({ ref: e, ref_key: t, ref_for: n }) => (
		typeof e == "number" && (e = "" + e),
		e != null ? (ce(e) || ye(e) || q(e) ? { i: de, r: e, k: t, f: !!n } : e) : null
	);
function Ye(e, t = null, n = null, r = 0, s = null, i = e === Ie ? 0 : 1, l = !1, c = !1) {
	...
	return (
		...
		Cn > 0 && !l && Pe && (o.patchFlag > 0 || i & 6) && o.patchFlag !== 32 && Pe.push(o),
		o
	);
}
const ee = Ia;
function Ia(e, t = null, n = null, r = 0, s = null, i = !1) {
	if (((!e || e === sa) && (e = mt), Tn(e))) {
		...
		return (
			n && Ms(c, n),
			Cn > 0 && !i && Pe && (c.shapeFlag & 6 ? (Pe[Pe.indexOf(e)] = c) : Pe.push(c)),
			(c.patchFlag = -2),
			c
		);
	}
	if ((Wa(e) && (e = e.__vccOpts), t)) {
		...
		c && !ce(c) && (t.class = xs(c)), Q(o) && (Ns(o) && !U(o) && (o = pe({}, o)), (t.style = Ss(o)));
	}
	const l = ce(e) ? 1 : al(e) ? 128 : qc(e) ? 64 : Q(e) ? 4 : q(e) ? 2 : 0;
...
function St(e = " ", t = 0) {
	return ee(Sr, null, e, t);
}
function La(e = "", t = !1) {
	return t ? (tn(), lr(mt, null, e)) : ee(mt, null, e);
}
function Qe(e) {
...
let cr, os;
{
	...
	(cr = t("__VUE_INSTANCE_SETTERS__", (n) => (me = n))), (os = t("__VUE_SSR_SETTERS__", (n) => (Pn = n)));
}
const Mn = (e) => {
		const t = me;
		return (
...
function _i(e, t, n) {
	q(t) ? (e.type.__ssrInlineRender ? (e.ssrRender = t) : (e.render = t)) : Q(t) && (e.setupState = Do(t)),
		pl(e);
}
function pl(e, t, n) {
	const r = e.type;
...
const ml = ls ? (e) => ls.createHTML(e) : (e) => e,
	...
	vi = at && at.createElement("template"),
	Ya = {
		insert: (e, t, n) => {
		...
		createElement: (e, t, n, r) => {
			const s =
				t === "svg"
					? at.createElementNS(Ja, e)
					: t === "mathml"
					? at.createElementNS(za, e)
					: n
...
function Jn(e, t, n) {
	if (U(n)) n.forEach((r) => Jn(e, t, r));
		...
		const r = ru(e, t);
		wi.test(n) ? e.setProperty(Mt(r), n.replace(wi, ""), "important") : (e[r] = n);
	}
}
...
function du(e, t) {
	...
	if (!n) return !1;
	const r = Ee(t);
	return Array.isArray(n) ? n.some((s) => Ee(s) === r) : Object.keys(n).some((s) => Ee(s) === r);
}
const ar = (e) => {
...
const ld = {
		created(e, { modifiers: { lazy: t, trim: n, number: r } }, s) {
			...
			Dt(e, t ? "change" : "input", (l) => {
				...
				t || (Dt(e, "compositionstart", pu), Dt(e, "compositionend", Pi), Dt(e, "change", Pi));
		},
		mounted(e, { value: t }) {
			e.value = t == null ? "" : t;
		},
...
function Te(e, t) {
	...
	function i(m) {
		return Et(this, arguments, function* (u, p = {}) {
			...
			try {
				s.promise = N(Ht(vt({}, e), { onError: void 0, params: u || e.params }));
			...
			insert: Te(
				{
					url: s,
					makeParams(P) {
						return { doc: vt({ doctype: o.doctype }, P) };
					},
					onSuccess(P) {
						var T, j;
						o.list.fetch(),
...
function Lu(e, t) {
	...
	let a = it({
		...
		setValue: Te(o, t),
		setValueDebounced: Te(Ht(vt({}, o), { debounce: e.debounce || 500 }), t),
		save: Te(
			Ht(vt({}, o), {
				makeParams() {
...
function Li(e, t) {
	return e.type === "document" ? Lu(e, t) : e.type === "list" ? Nu(e, t) : Te(e, t);
}
const vl = {
	install(e, t) {
		let n = Mu();
...
function Cf(e, t) {
	...
	const i = [];
	for (const f of e) {
		const a = f.length ? [] : [be.Root];
		n.strict && !f.length && (s += "/");
		for (let u = 0; u < f.length; u++) {
			const p = f[u];
			let m = be.Segment + (n.sensitive ? be.BonusCaseSensitive : 0);
			if (p.type === It.Static) u || (s += "/"), (s += p.value.replace(Of, "\\$&")), (m += be.Static);
			else if (p.type === It.Param) {
				...
				u || (B = w && f.length < 2 ? `(?:/${B})` : "/" + B),
					...
					(s += B),
					(m += be.Dynamic),
					w && (m += be.BonusOptional),
					R && (m += be.BonusRepeatable),
	...
	if (n.strict && n.end) {
		const f = r.length - 1;
		r[f][r[f].length - 1] += be.BonusStrict;
	}
	...
	function o(f) {
		...
		for (const p of e) {
			(!u || !a.endsWith("/")) && (a += "/"), (u = !1);
			for (const m of p)
				if (m.type === It.Static) a += m.value;
				else if (m.type === It.Param) {
...
function Kf(e) {
	...
	function T(b, L) {
		...
		return (
			...
			(v ? Promise.resolve(v) : Oe(y, M))
				.catch((_) => (ct(_) ? (ct(_, ie.NAVIGATION_GUARD_REDIRECT) ? _ : bt(_)) : J(_, y, M)))
				.then((_) => {
					if (_) {
	...
	function bt(b) {
		return Z || ((Z = !b), cn(), Ft.list().forEach(([L, I]) => (b ? I(b) : L())), Ft.reset()), b;
	}
	function Ke(b, L, I, M) {
		...
		Ct = {
			...
			install(b) {
				b.component("RouterLink", Vf),
					...
					$t && !Vt && o.value === wt && ((Vt = !0), O(s.location).catch((M) => {}));
				const L = {};
				for (const M in wt) Object.defineProperty(L, M, { get: () => o.value[M], enumerable: !0 });
				...
				Ut.add(b),
					(b.unmount = function () {
						Ut.delete(b),
							Ut.size < 1 &&
								((f = wt), qe && qe(), (qe = null), (o.value = wt), (Vt = !1), (Z = !1)),
							I();
					});
			},
		};
...
function Cr(r, s) {
	return Et(this, arguments, function* (e, t, n = {}) {
		t || (t = {});
		let i = Object.assign(
			{
		...
		Ht(vt({}, e), {
			transformRequest: (t = {}) => {
				...
				return (
					...
					Ht(vt({}, t), { method: t.method || "POST", headers: n })
				);
			},
	...
	return Et(this, null, function* () {
		try {
			if (window.user && window.user !== "Guest") {
				(kt.value = window.user), yield so(), (xn.value = !0);
				return;
			}
			...
			(kt.value = null), (Dn.value = []), (fr.value = !0);
		} finally {
			xn.value = !0;
		}
	});
...
function Nr() {
	io();
	const e = Ae(() => kt.value && kt.value !== "Guest"),
...
const qt = {
	...
	nd = {
		...
		setup(e) {
			...
			return (n, r) => {
				...
				return (
					tn(),
					fl("div", ed, [tt(t) ? (tn(), lr(Zh, { key: 0 })) : La("", !0), Ye("main", td, [ee(s)])])
				);
			};
		},
	},
	rd = [
		{ path: "/", redirect: "/service-portal" },
		{
			path: "/service-portal",
			name: "Dashboard",
			component: () => De(() => import("./Dashboard-Y4T2R-pp.js"), __vite__mapDeps([0, 1, 2])),
			meta: { requiresAuth: !0 },
		},
		{
			...
			component: () =>
				De(() => import("./DepotManagerDashboard-0K-8wo5u.js"), __vite__mapDeps([3, 2, 1])),
			meta: { requiresAuth: !0 },
		},
		{
			path: "/service-portal/central-ops",
			name: "CentralOpsDashboard",
			component: () => De(() => import("./CentralOpsDashboard-sdDGhZsz.js"), __vite__mapDeps([4, 2])),
			meta: { requiresAuth: !0 },
		},
		{
			path: "/service-portal/my-fleet",
			name: "CustomerDashboard",
			component: () => De(() => import("./CustomerDashboard-Kt0B4v1f.js"), __vite__mapDeps([5, 2, 1])),
			meta: { requiresAuth: !0 },
		},
		{
			path: "/service-portal/job-card/new",
			name: "JobCardNew",
			component: () => De(() => import("./JobCardNew-CZI8oxaO.js"), __vite__mapDeps([6, 7, 8, 9])),
			meta: { requiresAuth: !0 },
		},
		{
			path: "/service-portal/job-card/:jobCardName/health-card",
			name: "HealthCardView",
			component: () => De(() => import("./HealthCardView-Bj9BEJNp.js"), __vite__mapDeps([10, 2, 11])),
			meta: { requiresAuth: !0 },
			props: !0,
		},
		{
			...
			name: "JobCardDetail",
			component: () =>
				De(() => import("./CustomerJobCard-DlPTHSDa.js"), __vite__mapDeps([12, 2, 1, 11, 8, 13])),
			meta: { requiresAuth: !0 },
			props: !0,
		},
		{
			...
			component: () =>
				De(() => import("./TechnicianInspection-CncbqsP_.js"), __vite__mapDeps([14, 2, 7, 8, 15])),
			meta: { requiresAuth: !0 },
		},
		{
			path: "/service-portal/crm/leads",
			name: "LeadsList",
			component: () => De(() => import("./LeadsList-DuwekaiL.js"), __vite__mapDeps([16, 17, 2, 8, 18])),
			meta: { requiresAuth: !0 },
		},
		{
			...
			name: "LeadNew",
			component: () =>
				De(() => import("./LeadNew-L7lQULxj.js"), __vite__mapDeps([19, 7, 17, 2, 8, 20])),
			meta: { requiresAuth: !0 },
		},
		{
			...
			name: "LeadDetail",
			component: () =>
				De(() => import("./LeadDetail-BaEDrVGk.js"), __vite__mapDeps([21, 17, 2, 8, 22])),
			meta: { requiresAuth: !0 },
			props: !0,
		},
		{
			...
			name: "Login",
			component: () => De(() => import("./Login-dfpV-52z.js"), []),
		},
	],
...
//# sourceMappingURL=main-CCKo9z3F.js.map
